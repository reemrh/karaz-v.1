    ...
    render() {
        return (
            <div className='MyDatePicker'>
                <div className='mdp-input'  onClick={()=> this.showDatePicker(true)} hidden>
                    <input type='date' onChange={this.updateDateFromInput} ref={inputRef} hidden/>
                </div>                           
                <div onClick={()=> this.showDatePicker(true)} className='mdp-input'>
                  <div className="edit">
                      <label>تاريخ الميلاد</label>
                      <label className="feild-value">{this.state.inputValue}</label>
                      <div><img src={EditPen} /></div>               
                  </div>
                </div>
